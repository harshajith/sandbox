 ...
 *       &lt;sequence>
 *         &lt;element name="CreateLineMiscChargesFromQuoteResult" type="{http://epicor.com/webservices}SalesOrderDataSetType" minOccurs="0"/>
...
public class CreateLineMiscChargesFromQuoteResponse {
    ...
    @XmlElement(name = "CreateLineMiscChargesFromQuoteResult", nillable = true)
