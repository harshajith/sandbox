 ...
 *       &lt;sequence>
 *         &lt;element name="CreateLinesFromHistoryResult" type="{http://epicor.com/webservices}SalesOrderDataSetType" minOccurs="0"/>
...
public class CreateLinesFromHistoryResponse {
    ...
    @XmlElement(name = "CreateLinesFromHistoryResult", nillable = true)
