 ...
 *       &lt;sequence>
 *         &lt;element name="ChangeRevNumMasterResult" type="{http://epicor.com/webservices}SalesOrderDataSetType" minOccurs="0"/>
...
public class ChangeRevNumMasterResponse {
    ...
    @XmlElement(name = "ChangeRevNumMasterResult", nillable = true)
